...
def update_userinfo():
    ...
    try:
        ...
        if new_username and new_username != user.username:
            ...
            print(f"已更新用户名从 {old_username} 到 {new_username}")
        ...
        if new_password:
            ...
            print(f"已更新用户 {user.username} 的密码")
        ...
        if avatar:
            ...
            if avatar.startswith('data:image'):
                ...
                if file_path:
                    ...
                    print(f"已保存用户 {user.username} 的头像到文件: {file_path}")
                else:
                    print(f"头像保存失败")
                ...
                user.avatar = avatar
                print(f"已更新用户 {user.username} 的头像URL")

        db.session.commit()
        print(f"成功更新用户 {user.username} 的信息")
        return jsonify({
            'success': True, 
            'message': '用户信息更新成功',
            'data': user.to_dict()
